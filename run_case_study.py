...
from recbole.quick_start import run_recbole, run_recbole_case_study
...
if __name__ == '__main__':
    ...
    run_recbole_case_study(model=args.model, dataset=args.dataset, config_file_list=args.config_file_list)
