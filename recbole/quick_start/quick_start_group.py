...
from recbole.trainer import CustomTrainer
...
def run_recbole_group(
    ...
    trainer = CustomTrainer(config, model)#get_trainer(config["MODEL_TYPE"], config["model"])(config, model)
